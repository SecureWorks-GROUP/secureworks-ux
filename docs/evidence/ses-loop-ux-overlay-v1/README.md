# SES loop UX overlay v1

Offline proof of the three-defect ship. No network, no send, no invoice approve.
Regenerate: `node scripts/ses-loop-overlay-shot.js docs/evidence/ses-loop-ux-overlay-v1`
