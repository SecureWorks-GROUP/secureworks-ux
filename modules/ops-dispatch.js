    ...
    element.addEventListener('submit', async event => {
      ...
      try {
        ...
        if (type === 'transfer') {
          ...
          await save('receipt_transfer', { id: submittedForm.values.id, quantity, location: data.location, evidence: data.evidence }, id);
        }
