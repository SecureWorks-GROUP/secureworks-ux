...
(function (global) {
  ...
  function cell(a,key) {
    ...
    return '<button class="cellbtn '+(num(v.value)===null?'none':'')+'"'+drill(a.lane,key,a.row)+'><span class="v">'+fmt(v.value)+'</span><span class="u">'+esc(a.row?v.sub:'No report for this lane and week')+'</span></button>';
  }
  function funnel(as) {
