...
Feature flag: `?dragv2=1` or `localStorage.sw_cal_dragv2 = '1'` — DEFAULT OFF; off = the pre-CP1 calendar-delta drag, byte-identical (single Captain-authorized exception: the flag-off create-span fix below). When ON:
