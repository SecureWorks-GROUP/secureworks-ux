---
playbook_id: nithin.followup.v1
...
# Nithin · Follow-up loop

## Voice

Calm direct Aussie tradie. Doesn't push price. Lets the work talk.
Reframes price objections to spec, not discount. Five-touch ladder
then nurture.

## Templates

### send_follow_up · sms_primary
Hey {first_name}, Nithin - quote landed OK? Happy to walk you through anything that's not clear.

### send_follow_up · sms_fallback
Hey {first_name}, quote OK? Any questions?  - Nithin

### send_follow_up · sms_primary_nurture
Hey {first_name}, Nithin. No rush on the {job_number} quote - happy to keep it on file. Ping me if anything changes.

### send_follow_up · sms_fallback_nurture
Hey {first_name}, no rush on {job_number}. Ping me anytime.  - Nithin
...
Hey {first_name}, Nithin. Good question on {job_number} - I'll send a proper answer in the next hour.

### reply_needed · sms_fallback_objection
Hey {first_name}, got your question - reply incoming shortly.  - Nithin

### reply_needed · sms_primary_helpful
Hey {first_name}, got your message - Nithin on it. Reply incoming shortly.

### reply_needed · sms_fallback_helpful
Hey {first_name}, on it. Reply shortly.  - Nithin
...
Thanks for the message. Nithin here - I'll get back to you with a proper answer in the next hour.

 - Nithin

### stale_quote_recovery · sms_primary_nurture
Hey {first_name}, no pressure - happy to keep {job_number} on file. Ping me if anything changes.  - Nithin

### stale_quote_recovery · sms_fallback_nurture
Hey {first_name}, no pressure on {job_number}. Ping me anytime.  - Nithin

### stale_quote_recovery · sms_primary_value
Hey {first_name}, on the {value} {job_number} - that's certified engineering + insulated SolarSpan, not a kit. Worth a 5-min call?

### stale_quote_recovery · sms_fallback_value
Hey {first_name}, {value} covers engineering + insulated panels. 5-min call?  - Nithin
...
Hey {first_name}, {rep_first_name} here from SecureWorks - got your enquiry. I'll call within the hour to lock in a site visit.
...
Hey {first_name}, Nithin here. Quote accepted {hours_since_accepted} ago - when works for the deposit so I can lock in materials?

### deposit_follow_up · sms_fallback
Hey {first_name}, deposit when? Need to lock in materials.  - Nithin
